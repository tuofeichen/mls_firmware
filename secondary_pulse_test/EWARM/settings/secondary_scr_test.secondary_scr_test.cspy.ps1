...
{
& "E:\Program Files (x86)\IAR Systems\Embedded Workbench 8.0\common\bin\cspybat" -f "D:\mls_firmware\secondary_pulse_test\EWARM\settings\secondary_scr_test.secondary_scr_test.general.xcl" --debug_file=$debugfile --backend -f "D:\mls_firmware\secondary_pulse_test\EWARM\settings\secondary_scr_test.secondary_scr_test.driver.xcl" 
}
