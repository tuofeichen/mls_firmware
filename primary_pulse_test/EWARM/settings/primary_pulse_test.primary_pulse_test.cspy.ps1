...
{
& "E:\Program Files (x86)\IAR Systems\Embedded Workbench 8.0\common\bin\cspybat" -f "D:\mls_firmware\primary_pulse_test\EWARM\settings\primary_pulse_test.primary_pulse_test.general.xcl" --debug_file=$debugfile --backend -f "D:\mls_firmware\primary_pulse_test\EWARM\settings\primary_pulse_test.primary_pulse_test.driver.xcl" 
}
